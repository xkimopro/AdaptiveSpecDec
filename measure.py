...
ROOT = "sweep_results_kl"   # folder containing all results_L*_KL*_0.csv

# Regex to extract L and KL values from filenames
pattern = re.compile(r"results_L(?P<L>\d+)_KL(?P<KL>-?\d+)_0\.csv")
